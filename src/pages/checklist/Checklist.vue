...
<template>
  <div class="Checklist px-3 pad" style="max-width: 40.125rem; min-width: 30.125rem; margin: 0 auto">
    <!-- 닉네임 문구 -->
    <div class="text-secondary small">
      <span class="text-primary fw-semibold">{{ user }}</span> 님의
    </div>
    <div class="fs-4 fw-bold mt-1 mb-4">체크리스트 목록이에요</div>

    <!-- 상단 메뉴 -->
    <div class="d-flex justify-content-between align-items-center mb-3 pt-1">
      <router-link to="/checklist/create" class="text-primary small d-flex align-items-center text-decoration-none">
